...
export default function PlaceOrder() {
    ...
    const round2 = num => Math.round(num*100 + Number.EPSILON)/100; //123.456 => 13.46
    ...
    const placeOrderHandler = async() => {
        ...
        try{
            setLoading(true);
            const { data } = await axios.post('/api/orders', { orderItems: cartItems, shippingAddress, paymentMethod, itemsPrice, shippingPrice, taxPrice, totalPrice },
            {
                headers: {
                                        ...
                                        <TableRow key={item._id}>
                                            <TableCell>
                                                <NextLink href={`/product/${item.slug}`} passHref>
                                                    <Link>
                                                        <Image src={item.image} alt={item.name} width={70} height={70} ></Image>
                                                    </Link>
                                                </NextLink>
                                            </TableCell>     
                                            <TableCell>
                        ...
                        <List>
                            ...
                            <ListItem>
                                <Grid container>
                                    ...
                                    <Grid items xs ={6}>
                                        <Typography align="right"y>${shippingPrice}</Typography>
                                    </Grid>
                                </Grid>
                            </ListItem>
                            <ListItem>
